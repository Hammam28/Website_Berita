...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{route('menu.prosesUbah', $menu->id_menu)}}" method="post">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="radio">
                            <input type="radio" name="jenis_menu" value="page" id="page">
                            <label>Page</label>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="radio">
                            <input type="radio" name="target_menu" value="_self" id="self">
